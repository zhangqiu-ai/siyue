return await (async function runtime(figma, configs, pageId, expectedFonts, issueOffset) {
  const issues = [], frames = [], byCode = {}; let totalNodes = 0;
  ...
  for (const c of configs) {
    ...
    if (!root) { issue('missing-root', c.id, c.id, rootResult.error); f.issueCount = 1; f.pass = false; frames.push(compactFrame(f)); continue; }
    ...
    async function walk(direct, ancestorsVisible, disabledId, clipping) {
      if (f.nodes >= 3000 || totalNodes >= 48000) {
  ...
  if (bytes(output) > 16000) throw new Error('Coverage summary exceeds output budget; inspect one frame per call.');
  for (let i = issueOffset; i < issues.length; i++) {
    ...
    if (bytes(output) > 16500) { output.issues.pop(); output.returnedIssues--; output.nextIssueOffset = i; break; }
  }
  return output;
})(figma,[{"id":"515:35093","key":"reading-member"},{"id":"515:35255","key":"reading-member"},{"id":"515:35417","key":"reading-member"},{"id":"515:35579","key":"reading-member"},{"id":"515:35741","key":"reading-member"},{"id":"515:35903","key":"reading-member"},{"id":"515:36065","key":"reading-member"},{"id":"515:36227","key":"reading-member"},{"id":"515:36389","key":"reading-child"},{"id":"515:36551","key":"reading-child"},{"id":"515:36713","key":"reading-child"},{"id":"515:36875","key":"reading-child"},{"id":"515:37037","key":"reading-child"},{"id":"515:37199","key":"reading-child"},{"id":"515:37361","key":"reading-child"},{"id":"515:37523","key":"reading-child"},{"id":"515:37685","key":"revoke-chat-dialog"},{"id":"515:37818","key":"revoke-chat-dialog"},{"id":"515:37951","key":"revoke-chat-dialog"},{"id":"515:38084","key":"revoke-chat-dialog"},{"id":"515:38217","key":"revoke-chat-dialog"},{"id":"515:38350","key":"revoke-chat-dialog"},{"id":"515:38483","key":"revoke-chat-dialog"},{"id":"515:38616","key":"revoke-chat-dialog"},{"id":"515:38749","key":"shared-sent"},{"id":"515:38931","key":"shared-sent"},{"id":"515:39113","key":"shared-sent"},{"id":"515:39295","key":"shared-sent"},{"id":"515:39477","key":"shared-sent"},{"id":"515:39659","key":"shared-sent"},{"id":"515:39841","key":"shared-sent"},{"id":"515:40023","key":"shared-sent"}],"210:7",[],0);