...
async function linkEmail(who,loginAddress){
 ...
 await fx.email.linkConfirm(who.tokens.accessToken,{challengeId:proof.challengeId,requestSecret:proof.requestSecret,code,newPassword:'  synthetic-http-pass-🌙  '},randomUUID(),fx.context);
}
