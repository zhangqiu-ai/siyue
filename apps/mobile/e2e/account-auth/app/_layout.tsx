...
function Layout(){const theme=useTheme();return <GestureHandlerRootView style={{flex:1}}><ThemeProvider value={theme.mode==='dark'?DarkTheme:DefaultTheme}><StatusBar style={theme.mode==='dark'?'light':'dark'}/><AISettingsProvider><Stack><Stack.Screen name="whiteboard" options={{headerShown:false}}/><Stack.Screen name="plan-create" options={{headerShown:false}}/><Stack.Screen name="draft-scope" options={{headerShown:false}}/></Stack></AISettingsProvider></ThemeProvider></GestureHandlerRootView>;}
