...
const run=promisify(execFile),adb='/opt/homebrew/share/android-commandlinetools/platform-tools/adb',serial=process.env.SIYUE_QA_ANDROID??'emulator-5554',pkg='app.siyue.mobile.accountqa',accountPassword='siyue-qa-native7',taggedDevice='QA registration device';
