...
export default function ShellLayout() {
  const { t } = useLocale();
  const theme = useTheme();
  return <Drawer drawerContent={props => <Sidebar {...props} />} screenOptions={{ overlayAccessibilityLabel: t('sidebar.close'), headerShown: false, drawerType: 'front', drawerStyle: { backgroundColor: theme.color.background, width: 310 }, swipeEdgeWidth: 32 }}>
